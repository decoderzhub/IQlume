...
interface CreateIronCondorModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateIronCondorModal({ onClose, onSave }: CreateIronCondorModalProps) {
  const [strategyName, setStrategyName] = useState('Iron Condor');
  const [description, setDescription] = useState('Profit from low volatility with defined risk spreads');
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Iron Condor</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Iron Condor Strategy</h3>
