...
interface CreateArbitrageModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateArbitrageModal({ onClose, onSave }: CreateArbitrageModalProps) {
  const [strategyName, setStrategyName] = useState('Arbitrage');
  const [description, setDescription] = useState('Cross-exchange arbitrage strategy exploiting price differences between trading venues');
  const [minCapital, setMinCapital] = useState(12000);
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Arbitrage Strategy</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Arbitrage Strategy</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              This algorithmic strategy will be available in a future release. 
              It will exploit price differences between trading venues.
            </p>
