...
interface CreateShortCallModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateShortCallModal({ onClose, onSave }: CreateShortCallModalProps) {
  const [strategyName, setStrategyName] = useState('Short Call');
  const [description, setDescription] = useState('High-risk premium collection strategy selling naked calls with defined risk management');
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Short Call</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Short Call Strategy</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              This advanced options strategy will be available in a future release. 
              It will allow you to collect premium income with defined risk management.
            </p>
