...
interface CreateOptionCollarModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateOptionCollarModal({ onClose, onSave }: CreateOptionCollarModalProps) {
  const [strategyName, setStrategyName] = useState('Option Collar');
  const [description, setDescription] = useState('Protective strategy using option collars to limit downside while capping upside');
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Option Collar</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Option Collar Strategy</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              This advanced options strategy will be available in a future release. 
              It will allow you to protect positions while limiting upside.
            </p>
