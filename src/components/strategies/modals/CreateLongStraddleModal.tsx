...
interface CreateLongStraddleModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateLongStraddleModal({ onClose, onSave }: CreateLongStraddleModalProps) {
  const [strategyName, setStrategyName] = useState('Long Straddle');
  const [description, setDescription] = useState('Volatility play around earnings using long straddle for directional movement profits');
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Long Straddle</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Long Straddle Strategy</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              This advanced options strategy will be available in a future release. 
              It will allow you to profit from volatility around earnings and events.
            </p>
