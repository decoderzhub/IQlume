...
import { X, Shield, Target, Calendar } from 'lucide-react';
...
export function CreateCoveredCallsModal({ onClose, onSave }: CreateCoveredCallsModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error('Error creating covered calls strategy:', error);
    } finally {
      setIsCreating(false);
    }
  };
      ...
      >
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl font-bold text-white mb-2">Create Covered Calls Strategy</h2>
