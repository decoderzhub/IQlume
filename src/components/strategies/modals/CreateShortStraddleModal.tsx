...
interface CreateShortStraddleModalProps {
  onClose: () => void;
  onSave: (strategy: Omit<TradingStrategy, 'id'>) => Promise<TradingStrategy | null>;
}

export function CreateShortStraddleModal({ onClose, onSave }: CreateShortStraddleModalProps) {
  const [strategyName, setStrategyName] = useState('Short Straddle');
  const [description, setDescription] = useState('Ultra-high risk volatility selling strategy using short straddles for premium income');
        ...
        <Card className="p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Create Short Straddle</h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">Short Straddle Strategy</h3>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              This advanced options strategy will be available in a future release. 
              It will allow you to collect premium income from low volatility environments.
            </p>
