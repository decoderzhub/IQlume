      ...
      <section className="relative z-10 px-6 lg:px-12 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="relative"
          >
            <Card className="p-12 bg-gradient-to-r from-blue-900/40 via-purple-900/40 to-pink-900/40 backdrop-blur-xl border-blue-500/20">
              <motion.div
                animate={{
                  scale: [1, 1.05, 1],
                }}
                ...
                className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-8"
              >
      ...
      <footer className="relative z-10 px-6 lg:px-12 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; 2025 brokernomex. All rights reserved.</p>
